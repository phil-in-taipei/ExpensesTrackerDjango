...
from .views import create_expense, create_spending_record, delete_expense, \
    delete_spending_record, search_user_expenditures_by_month_and_year, \
    update_expense, user_expenses, user_expenditures_current_month, \
    user_expenditures_searched_month

app_name = 'expenses'
urlpatterns = [
    path('create-expense/', create_expense, name='create_expense'),
    path('create-spending-record/', create_spending_record,
         name='create_spending_record'),
    path('delete-expense/<int:id>/', delete_expense, name='delete_expense'),
    path('delete-spending-record/<int:id>/', delete_spending_record,
         name='delete_spending_record'),
